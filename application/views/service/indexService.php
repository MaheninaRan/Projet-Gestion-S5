...
<div class="container">
    <div class="row" >
        ...
        <div class="col-lg-3 log" onclick="loginAdmin()">Admin <br> Dg Login</div>
        <div class="col-lg-2"></div>
        <div class="col-lg-3 log" onclick="loginService()">Login <br> Service</div>
    </div>
</div>
...
<div id="popup" class="popup" >
  <div class="popup-content">
    <div class="row login">
      ...
      <div class="col-lg-5" id="anarana">Admin</div>
      <div class="col-lg-2"></div>
      <div class="col-lg-2 close" id="close" onclick="manidy()">X</div>
    </div> <br>
    <form action="<?= base_url("index.php/Admin/connexion") ?>" method="post">
        <div class="row">
...
<div id="loginService" class="popup" style="display:none">
  <div class="popup-content">
    <div class="row login">
        <div class="col-lg-3"></div>
      <div class="col-lg-5" id="anarana">Login Service</div>
      <div class="col-lg-2"></div>
      <div class="col-lg-2 close" id="close" onclick="manidy1()">X</div>
    </div> <br>
    <form action="<?= base_url("index.php/BackOffice/connexionService") ?>" method="post">
        <div class="row">
            <div class="col-lg-1"></div>
            <input class="col-lg-10 email" type="email" id="email" placeholder="Email" name="email"> <br>
        </div> <br>
