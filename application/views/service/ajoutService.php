              ...
              <div class="row tete">
                ...
                <div class="row" >
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
                        ...
                        <form action="<?php echo site_url('index.php/Admin/insertService');?>" method="post">
                                ...
                                <div class="col-lg-6"> 
                                    ...
                                    <div class="row">
                                        ...
                                        <input class="col-lg-7 col-xs-7" type="text" name="responsable" value="<?= set_value('responsable')?>" <?php if (form_error('responsable')) echo 'class="error"'; ?>>
				                          ...
				                          <div class="row">
                                        <div class="col-lg-2"></div>
                                        <div class="col-lg-2 col-xs-3">Email : </div>
                                        <input class="col-lg-7 col-xs-7" type="email" name="email" value="<?= set_value('email')?>" <?php if (form_error('email')) echo 'class="error"'; ?>>
                                    </div> <br>
                                    <div class="row">
                                        <div class="col-lg-2"></div>
