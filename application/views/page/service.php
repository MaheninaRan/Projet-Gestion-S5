...
<body>
    <h2>Liste service : </h2>
    <h2 style="text-align: center;"> <a href="<?php echo site_url("index.php/BackOffice/ajoutService");?>">Ajouter une nouvelle services</a> </h2>
    <?php 
        for ($i=0; $i < count($servicedetail); $i++) {  
    ?>
    <a href="<?php echo site_url("index.php/BackOffice/serviceCrud");?>">
